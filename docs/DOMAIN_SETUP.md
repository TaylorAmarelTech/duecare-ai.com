...
```text
GitHub repo      TaylorAmarelTech/duecare-ai.com
...
2. Connect the GitHub repo `TaylorAmarelTech/duecare-ai.com`.
3. Use branch `production`.
...
7. Add a persistent disk:
   ...
   - Size: `1 GB`
8. Confirm these environment variables:
...
The repo includes `render.yaml`, so Render may detect most of this automatically.
