...
3. Future NGO/government deployment channels that can provide rights-aware guidance without collecting raw worker cases.
...
The site is a small FastAPI app in a separate public repo:

- Repo: `TaylorAmarelTech/duecare-ai.com`
- Branch: `production`
...
7. **Use cases**
   Four cards:
   - Worker-side private checker
   - NGO caseworker copilot
...
- Scenario cards for worker, NGO, regulator, platform, researcher
