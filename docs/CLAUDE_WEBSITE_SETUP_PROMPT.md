...
You are working on the public website and coordination hub for Duecare AI, a Gemma 4 Good Hackathon project. The website is a separate public repository from the main Kaggle/monorepo.

Repository and deployment facts:

- Public repo: https://github.com/TaylorAmarelTech/duecare-ai.com
- Local folder: duecare-ai.com, separate from the main gemma4_comp workspace
...
- Create or connect a Render Docker web service from the production branch.
...
- Make changes in the website repo, not the main gemma4_comp monorepo, unless explicitly asked.
- Treat the main repo as the Kaggle/model/notebook source of truth and the website repo as the public hub/deployment source of truth.
